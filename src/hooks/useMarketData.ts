...
// Mock NSE Kenya stocks data (real API would require subscription)
const NSE_STOCKS: Asset[] = [
  { id: 'safaricom', symbol: 'SCOM', name: 'Safaricom PLC', price: 26.50, change24h: 2.5, volume24h: 15000000, marketCap: 1060000000000, category: 'nse' },
  ...
  { id: 'kcb', symbol: 'KCB', name: 'KCB Group PLC', price: 28.10, change24h: 0.8, volume24h: 6200000, marketCap: 90000000000, category: 'nse' },
  { id: 'eabl', symbol: 'EABL', name: 'East African Breweries', price: 145.00, change24h: -0.5, volume24h: 1200000, marketCap: 115000000000, category: 'nse' },
  ...
  { id: 'bamburi', symbol: 'BAMB', name: 'Bamburi Cement', price: 32.00, change24h: -2.1, volume24h: 950000, marketCap: 11600000000, category: 'nse' },
  { id: 'bat-kenya', symbol: 'BAT', name: 'BAT Kenya PLC', price: 380.00, change24h: 0.3, volume24h: 420000, marketCap: 38000000000, category: 'nse' },
  { id: 'absa-kenya', symbol: 'ABSA', name: 'ABSA Bank Kenya', price: 11.50, change24h: 1.5, volume24h: 3200000, marketCap: 62500000000, category: 'nse' },
];

// Global market indices simulation
const GLOBAL_STOCKS: Asset[] = [
  ...
  { id: 'nasdaq', symbol: 'QQQ', name: 'Nasdaq 100 ETF', price: 438.20, change24h: 1.2, volume24h: 62000000, marketCap: 210000000000, category: 'stock' },
  { id: 'apple', symbol: 'AAPL', name: 'Apple Inc.', price: 189.50, change24h: -0.3, volume24h: 45000000, marketCap: 2900000000000, category: 'stock' },
  ...
  { id: 'microsoft', symbol: 'MSFT', name: 'Microsoft Corp.', price: 415.80, change24h: 0.6, volume24h: 25000000, marketCap: 3090000000000, category: 'stock' },
];
...
export function useMarketData() {
  ...
  const fetchCryptoData = useCallback(async () => {
    try {
      ...
      const assets: Asset[] = data.map((coin: any) => ({
        id: coin.id,
...
function getFallbackCryptoData(): Asset[] {
  return [
    ...
    { id: 'avalanche-2', symbol: 'AVAX', name: 'Avalanche', price: 35.50, change24h: 2.8, volume24h: 580000000, marketCap: 14000000000, image: 'https://assets.coingecko.com/coins/images/12559/small/Avalanche_Circle_RedWhite_Trans.png', category: 'crypto' },
